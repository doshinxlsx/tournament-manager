...
export default function Modal({ teamName, matchId }: ModalType) {
                        ...
                        <form className="p-4 md:p-5" onSubmit={formik.handleSubmit}>
                            <div className="grid gap-4 mb-4 grid-cols-2">
                                <div className="col-span-2">
                                    <label htmlFor="team_name" className="block mb-2 text-sm font-medium text-gray-900">Csapat neve</label>
                                    <input type="text" {...formik.getFieldProps('teamName')} name="team_name" id="team_name" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Ird be a jatekvezeto nevet" />
                                </div>
                                <div className="col-span-2 sm:col-span-1">
                                    <label htmlFor="totalMatches" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Lejatszott meccsek</label>
                                    <input type="number" {...formik.getFieldProps('totalMatches')} name="totalMatches" id="totalMatches" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="0" />
                                </div>
                                <div className="col-span-2 sm:col-span-1">
                                    <label htmlFor="totalPoints" className="block mb-2 text-sm font-medium text-gray-900">Osszpontszam</label>
                                    <input type="number" {...formik.getFieldProps('totalPoints')} name="totalPoints" id="totalPoints" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="0" />
                                </div>
                            </div>
